...
// Mon=rest, Tue=easy, Wed=rest, Thu=easy, Fri=rest, Sat=long/easy, Sun=rest (or race week 50)
// Format: [tue_mi, thu_mi, sat_mi]
const PLAN_WEEKS: [number, number, number][] = [
  // --- Phase 1: Base Building (weeks 1–16, May 11 – Aug 30, 2026) ---
  [2, 2, 3],    // week 1  (7 mi)
  [2, 2, 4],    // week 2  (8)
  [2, 2, 4],    // week 3  (8)
  [2, 2, 3],    // week 4  (7 — cutback)
  [3, 3, 4],    // week 5  (10)
  [3, 3, 5],    // week 6  (11)
  [3, 3, 5],    // week 7  (11)
  [3, 3, 4],    // week 8  (10 — cutback)
  [3, 3, 6],    // week 9  (12)
  [3, 3, 7],    // week 10 (13)
  [4, 4, 7],    // week 11 (15)
  [3, 3, 5],    // week 12 (11 — cutback)
  [4, 4, 8],    // week 13 (16)
  [4, 4, 8],    // week 14 (16)
  [4, 4, 9],    // week 15 (17)
  [3, 3, 6],    // week 16 (12 — cutback)
  // --- Phase 2: Development (weeks 17–32, Aug 31 – Dec 20, 2026) ---
  [4, 4, 10],   // week 17 (18)
  [5, 5, 10],   // week 18 (20)
  [5, 5, 11],   // week 19 (21)
  [4, 4, 7],    // week 20 (15 — cutback)
  [5, 5, 12],   // week 21 (22)
  [5, 5, 12],   // week 22 (22)
  [5, 5, 13],   // week 23 (23)
  [4, 4, 8],    // week 24 (16 — cutback)
  [5, 5, 14],   // week 25 (24)
  [6, 6, 14],   // week 26 (26)
  [6, 6, 15],   // week 27 (27)
  [4, 4, 9],    // week 28 (17 — cutback)
  [6, 6, 16],   // week 29 (28)
  [6, 6, 16],   // week 30 (28)
  [5, 5, 12],   // week 31 (22)
  [3, 3, 6],    // week 32 (12 — transition)
  // --- Phase 3: Hal Higdon Novice 1 (weeks 33–50, Dec 21, 2026 – Apr 25, 2027) ---
  [3, 3, 6],    // week 33 (HH wk 1 — 12 mi)
  [3, 3, 7],    // week 34 (HH wk 2 — 13)
  [3, 3, 5],    // week 35 (HH wk 3 — 11 — cutback)
  [3, 3, 9],    // week 36 (HH wk 4 — 15)
  [3, 3, 10],   // week 37 (HH wk 5 — 16)
  [3, 3, 7],    // week 38 (HH wk 6 — 13 — cutback)
  [4, 4, 11],   // week 39 (HH wk 7 — 19)
  [4, 4, 13],   // week 40 (HH wk 8 — 21)
  [4, 4, 10],   // week 41 (HH wk 9 — 18 — cutback)
  [4, 4, 15],   // week 42 (HH wk 10 — 23)
  [5, 5, 16],   // week 43 (HH wk 11 — 26)
  [5, 5, 12],   // week 44 (HH wk 12 — 22 — cutback)
  [5, 5, 18],   // week 45 (HH wk 13 — 28)
  [5, 5, 14],   // week 46 (HH wk 14 — 24 — cutback)
  [5, 5, 20],   // week 47 (HH wk 15 — 30)
  [5, 5, 20],   // week 48 (HH wk 16 — 30)
  [4, 3, 12],   // week 49 (HH wk 17 — 19 — taper)
  [2, 2, 0],    // week 50 (HH wk 18 — 4 — race week)
];
...
function buildPlan(): Map<string, TrainingDay> {
  ...
  PLAN_WEEKS.forEach(([tue, thu, sat], i) => {
    const weekNum = i + 1;
